...
<div class="max-w-4xl mx-auto">
    <div class="mb-6">
        <h2 class="text-3xl font-bold text-gray-800">Admin Profile Settings</h2>
        <p class="text-gray-600 mt-2">Manage your administrator account information</p>
    </div>
        ...
        <form method="POST" action="{{ route('profile.update') }}">
            ...
            <div class="mb-4">
                ...
                <div class="flex items-center">
                    <span class="px-4 py-2 bg-maroon text-white rounded-lg font-medium">Administrator</span>
                    <span class="ml-3 text-sm text-gray-600">Full system access</span>
                </div>
            </div>
