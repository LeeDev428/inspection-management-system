    ...
    <section class="py-20 bg-gray-50">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h3 class="text-4xl font-bold text-gray-900 mb-4">About Us</h3>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    <p class="text-lg text-gray-700 leading-relaxed mb-6">
                        Welcome to the <strong>Inspection Management Office</strong>. We are dedicated to streamlining inspection processes and ensuring facility compliance across the Polytechnic University of the Philippines (PUP) campus.
                    </p>
                    <p class="text-lg text-gray-700 leading-relaxed mb-6">
                        Our mission is to provide a modern, efficient, and transparent system for managing inspection requests, approvals, and documentation. We strive to maintain the highest standards of safety, security, and regulatory compliance for all university facilities.
                    </p>
                    <p class="text-lg text-gray-700 leading-relaxed">
                        Through our digital platform, we empower departments and offices to easily submit inspection requests, track their status in real-time, and maintain comprehensive records—all while ensuring accountability and excellence in facility management.
                    </p>
                </div>

                <!-- Admin Contact Details -->
                <div class="bg-white p-8 rounded-xl shadow-lg">
                    <h4 class="text-2xl font-bold text-maroon mb-6 flex items-center">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start">
                            <svg class="w-5 h-5 text-maroon mr-3 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">admin@inspectionmgmt.com</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Polytechnic University of the Philippines<br>Sta. Mesa, Manila, Philippines</p>
                            </div>
                        </div>
